...
(function () {
  ...
  // Slug → category map, gebaut aus den Map-Pins
  function buildSlugCategoryMap() {
    ...
    document.querySelectorAll('.cru-ncf-pin').forEach(pin => {
      ...
      // ncf-category-exhibitions__shows → exhibitions
  ...
  function init() {
    ...
    // Pins sind evtl. noch nicht da → warten
    const check = setInterval(() => {
      ...
      // MutationObserver für nachgeladene Cards
